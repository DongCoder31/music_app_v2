...
class $AssetsAudioGen {
  ...
  /// List of all assets
  List<String> get values => [infinity, waveform];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/AlbumArt.jpg
  AssetGenImage get albumArt =>
      const AssetGenImage('assets/images/AlbumArt.jpg');

  /// File path: assets/images/Art1.jpg
  AssetGenImage get art1 => const AssetGenImage('assets/images/Art1.jpg');

  /// File path: assets/images/Art2.jpg
  AssetGenImage get art2 => const AssetGenImage('assets/images/Art2.jpg');

  /// File path: assets/images/Art3.jpg
  AssetGenImage get art3 => const AssetGenImage('assets/images/Art3.jpg');

  /// File path: assets/images/Art4.jpg
  AssetGenImage get art4 => const AssetGenImage('assets/images/Art4.jpg');

  /// File path: assets/images/Art5.jpg
  AssetGenImage get art5 => const AssetGenImage('assets/images/Art5.jpg');

  /// File path: assets/images/button.png
  AssetGenImage get button => const AssetGenImage('assets/images/button.png');

  /// File path: assets/images/country.jpg
  AssetGenImage get country => const AssetGenImage('assets/images/country.jpg');

  /// File path: assets/images/disk.png
  AssetGenImage get disk => const AssetGenImage('assets/images/disk.png');

  /// File path: assets/images/gcard.png
  AssetGenImage get gcard => const AssetGenImage('assets/images/gcard.png');

  /// File path: assets/images/heavymetal.jpg
  AssetGenImage get heavymetal =>
      const AssetGenImage('assets/images/heavymetal.jpg');

  /// File path: assets/images/hiphop.jpg
  AssetGenImage get hiphop => const AssetGenImage('assets/images/hiphop.jpg');

  /// File path: assets/images/pop.jpg
  AssetGenImage get pop => const AssetGenImage('assets/images/pop.jpg');

  /// File path: assets/images/scard.png
  AssetGenImage get scard => const AssetGenImage('assets/images/scard.png');
